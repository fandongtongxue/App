...
#import "FDVideoCallViewController.h"
#import <AgoraRtcEngineKit/AgoraRtcEngineKit.h>

@interface FDVideoCallViewController ()<AgoraRtcEngineDelegate>
...
@implementation FDVideoCallViewController
...
- (void)joinChannel {
    [self.agoraKit joinChannelByToken:@"" channelId:@"demoChannel1" info:nil uid:0 joinSuccess:^(NSString *channel, NSUInteger uid, NSInteger elapsed) {
...
- (void)resetHideButtonsTimer {
    [FDVideoCallViewController cancelPreviousPerformRequestsWithTarget:self];
    [self performSelector:@selector(hideControlButtons) withObject:nil afterDelay:3];
}
